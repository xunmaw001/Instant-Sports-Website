          ...
          <el-form-item class="input" label="商品名称" prop="shangpinmingcheng">
              <el-input v-model="ruleForm.shangpinmingcheng" 
                placeholder="商品名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商品种类" prop="shangpinzhonglei">
          <el-input v-model="ruleForm.shangpinzhonglei" 
              placeholder="商品种类" clearable  :readonly="ro.shangpinzhonglei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商品种类" prop="shangpinzhonglei">
              <el-input v-model="ruleForm.shangpinzhonglei" 
          ...
          <el-form-item class="input" label="规格" prop="guige">
              <el-input v-model="ruleForm.guige" 
                placeholder="规格" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="作用" prop="zuoyong">
          <el-input v-model="ruleForm.zuoyong" 
              placeholder="作用" clearable  :readonly="ro.zuoyong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="作用" prop="zuoyong">
              <el-input v-model="ruleForm.zuoyong" 
                placeholder="作用" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.guige = true;
            continue;
	            	            ...
	            	            if(o=='zuoyong'){
            this.ruleForm.zuoyong = obj[o];
	    this.ro.zuoyong = true;
            continue;
          }
	            	            if(o=='baozhiqi'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `jianshenshangpin/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jianshenshangpinCrossAddOrUpdateFlag = false;
                  this.parent.search();
