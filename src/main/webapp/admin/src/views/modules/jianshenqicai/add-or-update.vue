        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tupian" label="图片" prop="tupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tupian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="器材类型" prop="qicaileixing">
          <el-select v-model="ruleForm.qicaileixing" placeholder="请选择器材类型">
            <el-option
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shiyongfangfa" label="使用方法" prop="shiyongfangfa">
                    <span>{{ruleForm.shiyongfangfa}}</span>
                                ...
                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="瘦身效果" prop="shoushenxiaoguo">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shoushenxiaoguo" label="瘦身效果" prop="shoushenxiaoguo">
                    <span>{{ruleForm.shoushenxiaoguo}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                                                                                                                                      <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="器材介绍" prop="qicaijieshao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.qicaijieshao" label="器材介绍" prop="qicaijieshao">
                    <span v-html="ruleForm.qicaijieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
