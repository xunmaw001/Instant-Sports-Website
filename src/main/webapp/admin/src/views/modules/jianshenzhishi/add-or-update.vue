          ...
          <el-form-item class="input" label="文章标题" prop="wenzhangbiaoti">
              <el-input v-model="ruleForm.wenzhangbiaoti" 
                placeholder="文章标题" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="文章编号" prop="wenzhangbianhao">
            <el-input v-model="ruleForm.wenzhangbianhao" 
                placeholder="文章编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.wenzhangbianhao" label="文章编号" prop="wenzhangbianhao">
              <el-input v-model="ruleForm.wenzhangbianhao" 
                placeholder="文章编号" readonly></el-input>
          </el-form-item>
        </div>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `jianshenzhishi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jianshenzhishiCrossAddOrUpdateFlag = false;
                  this.parent.search();
