...
export default {
  ...
  computed: {
                                                                                    zongjiage:{
                                                                                                                                                                                      get: function () {
        return 1*this.ruleForm.shangpinjiage*this.ruleForm.goumaishuliang
      }
    },
                                                              },
  created() {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `shangpindingdan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shangpindingdanCrossAddOrUpdateFlag = false;
                  this.parent.search();
