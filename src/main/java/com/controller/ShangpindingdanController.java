...
public class ShangpindingdanController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,ShangpindingdanEntity shangpindingdan, HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("yonghu")) {
			shangpindingdan.setYonghuzhanghao((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ShangpindingdanEntity shangpindingdan, HttpServletRequest request){
        EntityWrapper<ShangpindingdanEntity> ew = new EntityWrapper<ShangpindingdanEntity>();
		PageUtils page = shangpindingdanService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, shangpindingdan), params), params));
        return R.ok().put("data", page);
    }
